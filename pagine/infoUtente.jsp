...
<body>
	...
	<div class="container-fluid bg-light">
		...
		<form action="../frontend/ServletGestioneInfoUtente.php" method="POST">
				...
				<div class="col-md-auto">
					<div class="form-group">
						...
						<select class="form-control" name="titoloStudio" required>
							...
							<option value="9">Bachelor's degree</option>
							<option value="10">Master's degree</option>
				...
				<div class="col-md-auto">
					<div class="form-group">
						...
						<select class="form-control" name="frequenza" required>
							<option value="">Open this selection menu</option>
							<option value="13">None or once a week</option>
							<option value="14">Twice a week</option>
							<option value="15">5 to 7 times a week</option>
						</select>
					</div>
				</div>
